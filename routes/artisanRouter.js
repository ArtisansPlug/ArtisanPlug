...
const { createProvider, verifyEmail, providerForm, deleteProvider } = require('../controllers/provider/provider.controller');
const { createArtisan, artistView, updateArtisan, artistDelete } = require('../controllers/provider/artisanWork.controller');
const { alertMessage } = require('../controllers/provider/request.alert.controller');
const { artisanPaystack } = require('../controllers/provider/transaction.controller');
