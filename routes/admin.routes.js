...
const { SwitchToAdmin, AllUsers, countUsersAndArtisans, softDeleteUser, createAlert, fetchAllAlerts, fetchActiveAlerts, AllProviders } = require('../controllers/admin/admin.controllers');
...
router.get('/providers',authenticate, isAdmin, AllProviders);
